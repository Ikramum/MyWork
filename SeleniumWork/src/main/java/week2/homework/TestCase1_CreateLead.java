...
public class TestCase1_CreateLead {

	public static void main(String[] args) throws InterruptedException {
		//creating html file for report
		ExtentHtmlReporter html = new ExtentHtmlReporter("./reports/testresult.html");
		//false- overwrite the existing file true- appends the report with existing file
		html.setAppendExisting(false);
		//making extent file as writable file.
		ExtentReports extent = new ExtentReports();
		extent.attachReporter(html);
		
		ExtentTest suittest = extent.createTest("TC-ID","TC-Desc");
		ExtentTest test=suittest.createNode("lead");
